...
public class ChangeUser extends javax.swing.JDialog {
    ...
    private void changeUser() {
        ...
        if (newUser.equals(us.getUsername())) {
            JOptionPane.showMessageDialog(null, "YOUR NEW USERNAME IS MATCH THE SAME WITH THE OLD USERNAME", "SAME USERNAME", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
    ...
    private void txtNewUsernameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNewUsernameFocusLost
        new txtField().checkTextFieldEmpty(txtNewUsername, "New Username");
    ...
    private void txtConfrimNewUsernameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtConfrimNewUsernameFocusLost
        new txtField().checkTextFieldEmpty(txtConfrimNewUsername, "Confrim New Username");
