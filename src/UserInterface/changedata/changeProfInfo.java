...
public class changeProfInfo extends javax.swing.JDialog {
    ...
    private boolean isValidToUpdate() {
        return !txtFirstname.getText().equals("FirtName") || txtFirstname.getText().isEmpty()
                || txtlastname.getText().isEmpty() || txtlastname.getText().equals("LastName")
                || cbgender.getSelectedItem().toString().equals("Gender") || datePicker2.getText().isEmpty();
    }
    ...
    private void initComponents() {
        ...
        datePicker2.setBounds(280, 140, 220, 50);
